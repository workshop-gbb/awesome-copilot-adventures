...
.toggle__sw button { padding: 10px 22px; border: 0; background: var(--ps-color-paper); font-family: var(--ps-font-mono); font-size: 12px; letter-spacing: .08em; text-transform: uppercase; cursor: pointer; color: var(--ps-color-ink-3); }
