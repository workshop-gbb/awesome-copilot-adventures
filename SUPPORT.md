...
Awesome Copilot Adventures is a community-maintained educational project and does not provide a commercial support SLA.
...
Before opening an issue, run the documented verifier and include the command, exit code, relevant output, operating system, runtime versions, and affected path.
