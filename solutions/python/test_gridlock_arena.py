...
def run_all_tests():
    ...
    try:
        ...
        if test_results.failed:
            print(f'\n💥 TEST SUITE FAILED: {test_results.failed} assertion(s) failed')
            for failure in test_results.errors:
                print(f'  - {failure}')
            return False
        
        print('\n🎉 ALL TESTS PASSED! 🎉')
        print('✅ Documented test cases passed')
        print('✅ Documented battle scenarios validated')
