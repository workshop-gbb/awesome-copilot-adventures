...
> [!NOTE]
> Questa sezione è conservata solo come riferimento storico. Le schermate del workshop sono state rimosse per proteggere i dati personali e il flusso del coupon potrebbe non essere più disponibile. Consulta i [piani GitHub Copilot attuali](https://github.com/features/copilot/plans) invece di seguire queste istruzioni archiviate.