...
# Rubric: The Agents of Stellaris
...
| Capability evidence | No adventure-specific artifact or verifier output. | An artifact exists but does not prove the named capability. | The test-focused custom agent, tool boundary, and handoff pass `node labs/stellaris-agents/verify.js`. | The evidence also demonstrates limitations, failure recovery, and independent reproducibility. |
...
- The test-focused custom agent, tool boundary, and handoff pass `node labs/stellaris-agents/verify.js`.
