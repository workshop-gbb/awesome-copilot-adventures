...
1. Restore `labs/stellaris-agents/starter/.github/agents/test-scout.agent.md` with `git restore`.
2. Close the starter workspace and discard only exercise-specific sessions.
3. Confirm `git status --short -- labs/stellaris-agents` is empty.
