---
title: "The Terminal Gate Rubric"
layout: default
nav_exclude: true
permalink: /adventures/04-surfaces/terminal-gate/rubric/
status: "ready"
last_verified: "2026-09-05"
---

# Rubric: The Terminal Gate
...
| Capability evidence | No adventure-specific artifact or verifier output. | An artifact exists but does not prove the named capability. | The safe command parser passes `node labs/terminal-gate/verify.js` against shell metacharacter and traversal cases. | The evidence also demonstrates limitations, failure recovery, and independent reproducibility. |
...
- The safe command parser passes `node labs/terminal-gate/verify.js` against shell metacharacter and traversal cases.
