...
| Capability evidence | No adventure-specific artifact or verifier output. | An artifact exists but does not prove the named capability. | The bounded remote task contract passes `node labs/cloud-citadel/verify.js` and names local verification evidence. | The evidence also demonstrates limitations, failure recovery, and independent reproducibility. |
...
- The bounded remote task contract passes `node labs/cloud-citadel/verify.js` and names local verification evidence.
