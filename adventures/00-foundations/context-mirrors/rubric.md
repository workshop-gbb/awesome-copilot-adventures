---
title: "The Context Mirrors Rubric"
layout: default
nav_exclude: true
permalink: /adventures/00-foundations/context-mirrors/rubric/
status: "ready"
last_verified: "2026-09-05"
---

# Rubric: The Context Mirrors
...
| Capability evidence | No adventure-specific artifact or verifier output. | An artifact exists but does not prove the named capability. | A controlled context comparison and completed baseline pass `node labs/context-mirrors/verify.js`. | The evidence also demonstrates limitations, failure recovery, and independent reproducibility. |
...
- A controlled context comparison and completed baseline pass `node labs/context-mirrors/verify.js`.
